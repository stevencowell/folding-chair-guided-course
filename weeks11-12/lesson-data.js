...
window.MC_QUESTIONS = [
  ...
  },
  {
    ...
    "options": [
      ...
      "The final service life of the chair",
  ...
  },
  {
    ...
    "options": [
      ...
      "Loose joints always become moving pivots",
    ...
    "feedback": [
      ...
      "A loose fixed joint does not become a designed pivot.",
  ...
  {
    "question": "A timber component is 450 mm long and costs $8.00 per metre. What is the material cost for one component before waste allowance?",
    "options": [
      "$0.36",
      "$3.60",
      "$36.00",
    ...
    "correct": 1,
    "hint": "Convert 450 mm to 0.45 m before multiplying.",
    "strongHint": "0.45 × 8.00 gives the cost in dollars.",
    "feedback": [
      "$0.36 would result from an incorrect decimal calculation.",
      "$3.60 is 0.45 m multiplied by $8.00 per metre.",
      "$36.00 treats the component as 4.5 m long.",
      "$360.00 is far beyond the correct unit conversion."
    ]
  },
  {
    "question": "Why should a costing include a justified waste allowance?",
    "options": [
      "Real production may require extra material for defects, saw kerfs, dressing and selection",
      "Waste makes the design automatically sustainable",
      "It removes the need to measure components",
      "It guarantees every offcut is discarded"
    ],
    "correct": 0,
    "hint": "Purchased length must cover more than the exact net size of the finished parts.",
    "strongHint": "The allowance should reflect real losses, not be an unexplained large percentage.",
    "feedback": [
      "A controlled allowance accounts for unavoidable production losses and material selection.",
      "Waste still needs to be minimised and managed.",
      "Accurate measurement remains necessary.",
      "Useful offcuts may be retained or reused."
    ]
  },
  {
  ...
  },
  {
    ...
    "options": [
      "Confirm the chair folds correctly and all glue residue is removed",
      "Choose background music",
      "Throw away all drawings",
      "Skip the hardware check"
    ],
    "correct": 0,
    "hint": "Finishing can hide residue and reduce clearances, so function and surface quality need approval first.",
    "strongHint": "A hold point requires evidence that the next high-cost process is safe to begin.",
    "feedback": [
      "Function and surface checks should pass before coating is applied.",
      "Music is not project quality evidence.",
      "Drawings remain important records.",
      "Hardware is part of the moving mechanism and must be checked."
    ]
  },
  {
...
window.WRITTEN_QUESTIONS = [
  ...
  },
  {
    ...
    "scaffold": [
      "First, the net timber length is…",
      "After adding the 12% allowance…",
      "The timber cost is…",
      "Hardware and consumables add…",
      "Therefore the estimated direct cost is…"
    ],
    "prompts": [
      "Show 4 × 520 mm and convert the result to metres.",
      "Apply the 12% allowance to the net length, not to the final dollar total unless stated.",
      "Multiply the allowed length by $11.80 per metre and round sensibly.",
      "Add both stated non-timber amounts.",
      "State the final result in dollars and make the calculation traceable."
    ],
    "model": "The net length is 4 × 520 mm = 2080 mm, which is 2.08 m. Adding a 12% allowance gives 2.08 × 1.12 = 2.3296 m. The timber cost is 2.3296 × $11.80 = $27.48928, which rounds to $27.49. Hardware and consumables cost $8.60 + $4.20 = $12.80. The estimated direct cost is therefore $27.49 + $12.80 = $40.29. I would record the unrounded values in the working and the rounded dollar values in the final costing so another person can check the method."
  },
  {
    ...
    "model": "The sequence begins with a final dry assembly because glue-up depends on correct fit, hardware clearance and a proven clamp method. The first hold point is teacher or checklist approval that all joints close, the frame is square and the chair moves correctly. Glue-up then occurs within the adhesive open time, followed by the full required clamp and cure periods. While the assembly is clamped, I can update the folio, costing and production record in parallel. After unclamping, the second hold point checks joint closure, alignment and remaining glue residue before surface preparation begins. The first finish coat depends on a clean, defect-free surface and another functional check. I would place a buffer before finishing to allow correction of a joint, extra adhesive cure or an additional sanding step. Actual times and delays would be recorded and the remaining plan revised rather than hidden."
  }
];
